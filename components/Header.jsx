...
function Header() {
  return (
    <header className="flex justify-center items-center self-stretch px-16 py-2 w-full text-xl font-medium leading-9 text-black bg-pink-50 max-md:px-5 max-md:max-w-full">
